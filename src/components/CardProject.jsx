...
const CardProject = ({ Img, Title, Description, Link: ProjectLink, github, Features = [], id }) => {
  ...
  return (
    <div className="group relative w-full h-full flex">
      ...
      <div className="relative overflow-hidden rounded-xl bg-white/1 backdrop-blur-lg border border-white/10 shadow-2xl transition-all duration-300 hover:shadow-purple-500/20 w-full h-full flex flex-col">
