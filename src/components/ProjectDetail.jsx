...
const FeatureItem = ({ feature }) => {
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
      ...
      <span className="text-sm md:text-base text-white group-hover:text-white transition-colors">
        {feature}
      </span>
    </li>
  );
    ...
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4  rounded-xl overflow-hidden relative">
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-blue-500/20 transition-all duration-300 hover:scale-105 hover:border-blue-500/50 hover:shadow-lg">
        ...
        <div className="flex-grow">
          ...
          <div className="text-[10px] md:text-xs text-white">Total Technology</div>
        </div>
      </div>
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-purple-500/20 transition-all duration-300 hover:scale-105 hover:border-purple-500/50 hover:shadow-lg">
        ...
        <div className="flex-grow">
          ...
          <div className="text-[10px] md:text-xs text-white">Key Features</div>
        </div>
      </div>
    </div>
  );
...
const ProjectDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-white/10 px-[2%] sm:px-0 relative overflow-hidden">
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                >
                  ...
                  <span className="relative font-medium text-white">Live Demo</span>
                </a>
                ...
                >
                  ...
                  <span className="relative font-medium text-white">Github</span>
                </a>
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                {project.TechStack.length > 0 ? (
                  ...
                  <p className="text-sm md:text-base text-white opacity-50">No technologies added.</p>
                )}
              </div>
            </div>
